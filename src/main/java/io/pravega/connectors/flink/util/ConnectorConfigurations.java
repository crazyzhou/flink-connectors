...
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_CONNECTION_CONFIG_CONTROLLER_URI;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_CONNECTION_CONFIG_DEFAULT_SCOPE;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_CONNECTION_CONFIG_SECURITY_AUTH_TOKEN;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_CONNECTION_CONFIG_SECURITY_AUTH_TYPE;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_CONNECTION_CONFIG_SECURITY_TRUST_STORE;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_CONNECTION_CONFIG_SECURITY_VALIDATE_HOSTNAME;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_METRICS;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_READER_GROUP_CHECKPOINT_INITIATE_TIMEOUT_INTERVAL;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_READER_GROUP_EVENT_READ_TIMEOUT_INTERVAL;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_READER_GROUP_NAME;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_READER_GROUP_REFRESH_INTERVAL;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_READER_GROUP_SCOPE;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_READER_GROUP_UID;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_STREAM_INFO;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_STREAM_INFO_END_STREAMCUT;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_STREAM_INFO_SCOPE;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_STREAM_INFO_START_STREAMCUT;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_STREAM_INFO_STREAM;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_READER_USER_TIMESTAMP_ASSIGNER;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_WRITER_ENABLE_WATERMARK;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_WRITER_MODE;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_WRITER_MODE_VALUE_ATLEAST_ONCE;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_WRITER_MODE_VALUE_EXACTLY_ONCE;
import static io.pravega.connectors.flink.table.descriptors.Pravega.CONNECTOR_WRITER_ROUTING_KEY_FILED_NAME;
